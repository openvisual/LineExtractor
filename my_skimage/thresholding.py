...
from .utils import check_nD, warn
from skimage.transform import integral_image
from skimage.util import crop, dtype_limits
from .multiotsu import (_get_multiotsu_thresh_indices_lut, _get_multiotsu_thresh_indices)
...
def _try_all(image, methods=None, figsize=None, num_cols=3, verbose=True):
